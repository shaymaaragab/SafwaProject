...
@section('title') Health Care @endsection
@section('header_english')
    @include('partials.header_health_en')
@stop
@section('navbar')
    @include('partials.nav_healthcare_en')
@stop
@section('content')
<section class="homes1" style="margin-top: 11%">
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-12">
                <h1 style="text-align:center"><span style='color: #bee214;'>About Us</span></h1>
                <div class="careers__title" style="text-align: left;" id ="aboutus">
        ...
        <div class="row">
            <div class="col-md-12">
                <h1 style="text-align:center"><span style='color: #bee214;'>Services</span></h1>
                <div class="careers__title" style="text-align: left;" id ="aboutus">
...
@endsection
@section('footer')
 @include('partials.footer_en_health')
@endsection