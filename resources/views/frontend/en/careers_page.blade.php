...
@section('title') {{ $job->title_en }} @endsection
                            ...
                            <div class="careers__contact">
                                ...
                                <br>
                                  <div class='careers--details'>
                                    <h4 style="display: inline-block;"><strong>Location :</strong> </h4>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input required onchange="nameValidation(this.value)" type="text" class="name" id="name"
                                           placeholder="name" style="width: 100%" name="name"/>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input required onchange="emailValidation(this.value)" type="text" class="email" id="email"
                                           placeholder="email" style="width: 100%" name="email"/>
                                </div>
                                <div class="col-md-3">
                                    ...
                                    <input required onchange="phoneValidation(this.value)" type="text" class="phone" id="phone"
                                           placeholder="phone" style="width: 100%" name="phone"/>
                                </div>
                                <div class="col-md-5"></div>
                            </div>
