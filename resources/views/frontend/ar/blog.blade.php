    ...
    <div class="blog">
            <div class="row">
                <div class="col-md-12 col-sm-12">
                    ...
                    <h3 class="blog--recent">اخر المقالات</h3>
                </div>
            </div>
            @if($blogs->count() > 0)
            <div class="row">
                <div class="col-md-12 col-sm-12">
                    ...
                    @foreach ($blogs as $blog)
                        <div class='blog__item'>
                            ...
                            <div class='blog--type text-right'>
                                <a href="{{ route('Bloginner',$blog->id) }}">
                                    <h4><strong>{{$blog->title_ar}} </strong> </h4>
                                </a>
                                <p>{{$blog->created_at->diffForHumans()}}</p>
                                <p>
                                <p>{!!  str_limit($blog->content_ar, $limit = 200, $end = '...') !!}</p>
        ...
        <br>
        <br>
        <h1 class="text-center" style="color: red;"> لا يوجد موضوعات </h1>
        <br>
        <br>
        <br>
