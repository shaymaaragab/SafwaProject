                            ...
                            <div class='contacts__item'>
                                <div style="width: 200px;">
                                    <div style="background-image: url({{ asset($temmember->img)  }}); width: 200px;height: 155px;background-size: cover;">
                                        <img style="width: 306px;position:relative;top: -73px;left: 52px;" src="{{asset('assets/img/puzzelll.png')}}">
                                    </div>
                                </div>
                                <h4>{{ $temmember->name_ar }}</h4>
                                <p>{{ $temmember->position_ar }}</p>
