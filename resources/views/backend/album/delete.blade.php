  ...
  <div class='modal-dialog'>
    ...
    <div class='modal-content'>
      ...
      <div class='modal-body'>
        <h4 class="text-center">This Album may have Images and Videos <BR> Do You Want to Delete this ??</h4>
      </div>
      <div style='clear: both'></div>
      <div class='modal-footer'>
      <a href="{{route('DeleteAlbum',$album->id)}}" class='btn btn-primary'>Ok</a>
