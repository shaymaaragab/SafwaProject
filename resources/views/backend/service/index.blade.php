...
@section('page_header','Service')
@section('page_header_desc','Service Here')
@section('curreny_page','Service')
                        ...
                        @foreach($service as $about)
                            <tr>
                                ...
                                <td class="text-center">
                                    ...
                                    <a type='button' style='margin-left: 5px;' class='btn btn-warning btn-xs' href="{{route('EditService',$about->id)}}"><i class='fa fa-edit'>Edit</i></a>
