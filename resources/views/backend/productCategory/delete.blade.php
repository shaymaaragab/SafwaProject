  ...
  <div class='modal-dialog'>
    ...
    <div class='modal-content'>
      ...
      <div class='modal-body'>
        <h4 class="text-center">This Category may has Subcategoris and Child Product <BR> Do you want to delete them all ?</h4>
      </div>
      <div style='clear: both'></div>
      <div class='modal-footer'>
      <a href="{{route('DeleteProductcategory',$category->id)}}" class='btn btn-primary'>Ok</a>
