...
@section('page_header','Add Currency')
@section('page_header_desc','Add Currency Here')
@section('curreny_page','Add Currency')
@section('main-content')
     ...
     <div class="page-content">
        <div class="col-md-12">
            ...
            {{ Form::open(['route' => 'CreateCurrency', 'class' => 'form', 'role' => 'form']) }}
